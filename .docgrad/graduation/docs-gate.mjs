...
const THRESHOLDS = {
  ...
  min_freshness_coverage: 1, // date-signal coverage ratio
  max_entry_cost_tokens: 2651, // entry-file fixed cost: the tax every task has to pay
  max_pollution_ratio: 0, // junk share of the corpus (tokens matched by exclude ÷ all collected doc tokens); pinned to this repo's ratio at graduation, not to docgrad's shipped default
};
